...
public abstract class Card extends AbstractCard {
	...
	public Card(String title, String desc, String third){
		this.title = title;
		this.desc = desc;
		this.third = third;
	}
	
	public Card(String tableId, String title, String desc, String third){
		this.title = title;
		this.desc = desc;
		this.third = third;
	...
	public Card(String tableId, String title, String desc, String third,int status){
		this.title = title;
		this.desc = desc;
		this.third = third;
		this.tableId=tableId;
	...
	public abstract void cardswipeactions();
