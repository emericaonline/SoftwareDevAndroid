...
public class update {
	...
	public static int connect(String url) throws ClientProtocolException,
		...
		try {
			...
			Log.i("starting sending num : ", Integer.toString(count));
			...
			while (count >= 0) {
				...
				Log.i("Title_send","'"+AsyncHelper.getName()+"'");
				Log.i("tableId_send","'"+AsyncHelper.getTable()+"'");
				Log.i("status_send","'"+AsyncHelper.getSearch()+"'");
